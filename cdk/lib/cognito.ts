...
export class CognitoResources extends Construct {
  ...
  constructor(scope: Construct, id: string, props: CognitoResourcesProps) {
    ...
    const domainValidator = new NodejsFunction(this, "domainValidator", {
      entry: "lib/resources/domainValidator/index.ts",
    ...
    const userPool = new UserPool(this, "UserPool", {
      ...
      userInvitation: {
        emailSubject: `Your ${props.appName} temporary password`,
        emailBody: `Your ${props.appName} username is {username} and temporary password is {####}`,
      },
      userVerification: {
        emailSubject: `Verify your ${props.appName} account`,
        emailBody: `The verification code to your ${props.appName} account is {####}`,
      },
    });
